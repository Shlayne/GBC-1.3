...
namespace gbc
{
	...
	public:
		...
		constexpr float GetPerspectiveFOV() const noexcept { return perspectiveFOV; }
		inline void SetPerspectiveFOV(float fov) { perspectiveFOV = fov; Recalculate(); }
		constexpr float GetPerspectiveNearClip() const noexcept { return perspectiveNear; }
		inline void SetPerspectiveNearClip(float nearClip) { perspectiveNear = nearClip; Recalculate(); }
		constexpr float GetPerspectiveFarClip() const noexcept { return perspectiveFar; }
		inline void SetPerspectiveFarClip(float farClip) { perspectiveFar = farClip; Recalculate(); }

		void SetOrthographic(float size, float nearClip, float farClip);
		constexpr float GetOrthographicSize() const noexcept { return orthographicSize; }
		inline void SetOrthographicSize(float size) { orthographicSize = size; Recalculate(); }
		constexpr float GetOrthographicNearClip() const noexcept { return orthographicNear; }
		inline void SetOrthographicNearClip(float nearClip) { orthographicNear = nearClip; Recalculate(); }
		constexpr float GetOrthographicFarClip() const noexcept { return orthographicFar; }
		inline void SetOrthographicFarClip(float farClip) { orthographicFar = farClip; Recalculate(); }

		constexpr ProjectionType GetProjectionType() const noexcept { return projectionType; }
